...
const translations = {
  en: {
    ...
    upgrade: {
      ...
      heading: "Upgrade to QuoteFlow Pro",
      subheading: "Unlimited proposals, full library, and PDF export.",
      monthly: "Monthly",
      annual: "Annual",
      save35: "Save 35%",
      freePlan: "Free",
      freeDesc: "Great for trying out QuoteFlow",
      currentPlan: "Current plan",
      proPlan: "Pro",
      billingNote: "",
      cancelNote: "Cancel anytime. No lock-in.",
    ...
    prices: {
      ...
      billedAnnually: (total: string, savings: string) =>
        `Billed $${total}/year · saves ${savings}`,
      upgradeMonthly: (price: string) => `Upgrade — $${price}/month →`,
      upgradeAnnual: (total: string) => `Upgrade — $${total}/year →`,
    },
    // Footer
  ...
  th: {
    ...
    upgrade: {
      badge: "ราคาโปร่งใส",
      heading: "อัปเกรดเป็น QuoteFlow Pro",
      subheading: "ข้อเสนอไม่จำกัด คลังข้อเสนอครบครัน และส่งออก PDF",
      monthly: "รายเดือน",
      annual: "รายปี",
      save35: "ประหยัด 35%",
      freePlan: "ฟรี",
      freeDesc: "เหมาะสำหรับทดลองใช้ QuoteFlow",
      currentPlan: "แผนปัจจุบัน",
      proPlan: "Pro",
      billingNote: "",
      cancelNote: "ยกเลิกได้ตลอดเวลา ไม่มีสัญญาผูกมัด",
      redirecting: "กำลังไปยังหน้าชำระเงิน…",
      back: "← กลับไปยังข้อเสนอ",
      freeFeatures: [
        "3 ข้อเสนอต่อเดือน",
        "สร้างด้วย AI",
        "คัดลอกไปยังคลิปบอร์ด",
    ...
    prices: {
      ...
      billedAnnually: (total: string, savings: string) =>
        `ชำระ ฿${total}/ปี · ประหยัด ${savings}`,
      upgradeMonthly: (price: string) => `อัปเกรด — ฿${price}/เดือน →`,
      upgradeAnnual: (total: string) => `อัปเกรด — ฿${total}/ปี →`,
    },
    // Footer
